...
$(document).ready(function() {
    ...
    const svgPath = document.querySelectorAll('.cls-3');
    var fun = function () {
        $('.banners-title .text').css({opacity: 1}).animate({opacity: 0}, function (e) {
            $('.banners-title .text').css({opacity: 1});
            const svgText = anime({
                targets: svgPath,
                loop: false,
                direction: 'none',
    ...
    $(".banners-container .banner:nth-child(1)").addClass("in");
    resetInterval();
